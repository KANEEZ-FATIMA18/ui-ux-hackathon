  ...
  return (
    <div className="min-h-screen bg-white p-4 md:p-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-2 bg-white">
          <div className="overflow-x-auto">
            <table className="w-full text-left mt-6 mb-8 border-collapse">
              <thead>
                <tr className="uppercase text-sm md:text-lg text-[#1D3178]">
                  <th className="py-2 px-4 md:py-3 md:px-6">Product</th>
                  <th className="py-2 px-4 md:py-3 md:px-6">Price</th>
                  <th className="py-2 px-4 md:py-3 md:px-6">Quantity</th>
                  <th className="py-2 px-4 md:py-3 md:px-6">Total</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-sm md:text-base divide-y divide-gray-200">
                {products.map((product) => (
                  <tr key={product.id}>
                    <td className="py-4 px-4 flex items-center">
                      <Image
                        ...
                        width={83}
                        height={87}
                        className="w-[60px] h-[60px] md:w-[83px] md:h-[87px] rounded-md mr-4"
                      />
                      <div>
                    ...
                    <td className="py-4 px-4">
                      <input
                        type="number"
                        className="w-16 md:w-20 border border-gray-300 rounded-md text-center focus:ring focus:ring-blue-200"
                        defaultValue={1}
                      />
                    </td>
                    <td className="py-4 px-4">${product.total.toFixed(2)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 px-4 py-4">
            <button className="bg-pink-500 text-white px-4 py-2 rounded-md hover:bg-pink-600 w-full sm:w-auto">
              Update Cart
            </button>
            <button className="bg-pink-500 text-white px-4 py-2 rounded-md hover:bg-pink-600 w-full sm:w-auto">
              Clear Cart
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex flex-col items-center">
            <h2 className="text-xl md:text-2xl font-bold mb-4 text-[#1D3178]">Cart Totals</h2>
            <div className="bg-[#F4F4FC] shadow-sm rounded-md p-4 md:p-6 w-full sm:w-[371px] border border-gray-200">
              <div className="flex justify-between items-center text-gray-600 mb-4 pb-4 border-b border-gray-400">
                <span className="text-base md:text-lg font-bold text-[#1D3178]">Subtotals:</span>
                <span className="font-medium text-[#1D3178]">£219.00</span>
              </div>
              <div className="flex justify-between items-center text-gray-600 mb-7 pb-4 border-b border-gray-400">
                <span className="text-base md:text-lg font-bold text-[#1D3178]">Totals:</span>
                <span className="font-medium text-[#1D3178]">£325.00</span>
              </div>
              <div className="text-sm text-gray-500 flex items-center">
                <span className="inline-block w-4 h-4 bg-green-500 rounded-full mr-2"></span>
              ...
              <button className="w-full bg-green-500 text-white py-3 mt-6 text-sm md:text-base font-semibold hover:bg-green-600">
                Proceed to Checkout
              </button>
            </div>
          </div>
          ...
          {/* Calculate Shipping */}
          <div className="flex flex-col items-center">
            <h2 className="text-xl md:text-2xl text-[#1D3178] font-bold mb-4">Calculate Shipping</h2>
            <div className="bg-[#f2f1f6] shadow-sm rounded-md p-4 md:p-6 w-full sm:w-[371px]">
              <input
                type="text"
                placeholder="Bangladesh"
                className="w-full mb-4 border-b bg-[#f2f1f6] border-gray-400 p-2 focus:ring focus:ring-white"
              ...
              <input
                ...
                className="w-full mb-4 border-b bg-[#f2f1f6] border-gray-400 p-2 focus:ring focus:ring-white"
              />
              <button className="w-full bg-pink-500 text-white py-2 mt-6 rounded-md hover:bg-pink-600">
                Calculate Shipping
              </button>
            </div>
          </div>
