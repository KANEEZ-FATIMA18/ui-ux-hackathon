...
//   return (
//     <section className="relative h-[764px] bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
//       {/* Left Column: Lamp */}
...
//         </p>
//         <h1 className="text-3xl  font-[josefin sans] md:text-4xl font-bold text-indigo-950 leading-tight mt-2">
//           {current.title}
//         </h1>
...
function HeroSection() {
  ...
  return (
    <section className="relative h-auto bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      {/* Left Column: Lamp */}
      <div className="md:w-1/4 flex justify-center items-start relative">
        <div className="absolute top-[-250px] md:top-[-350px] left-[-40px] z-10">
          <Image
            src={'/image 32.png'}
            alt="Lamp"
            width={387}
      ...
      {/* Center Column: Content (Title, Description, Button) */}
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center md:justify-start">
        <p className="text-sm text-pink-500 font-medium">
          Best Furniture For Your Castle...
        </p>
        <h1 className="text-3xl font-[josefin sans] md:text-4xl font-bold text-indigo-950 leading-tight mt-2">
        ...
        <Link
          href="#"
          className="inline-block bg-pink-500 text-white text-sm font-medium py-3 px-6 rounded-md mt-6 hover:bg-pink-600 transition-all duration-300 w-full md:w-1/3 text-center"
        >
          {current.buttonText}
        </Link>
      </div>
